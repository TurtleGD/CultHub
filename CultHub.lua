...
Controller.Text = "The Controller"
...
Paladin.MouseButton1Click:Connect(function()
	while game:GetService("RunService").Heartbeat:Wait() do
		...
		game:GetService("Players").LocalPlayer.Character:FindFirstChild("Equinox Crossbow").RemoteFunction:InvokeServer(unpack(args))
	end
end)
...
TSUBOL.MouseButton1Click:Connect(function()
	while game:GetService("RunService").Heartbeat:Wait() do
		local args = {
			[1] = "hit",
			[2] = {
				[1] = workspace:FindFirstChild("TSUBOL").Humanoid,
				[2] = 900,
				[3] = false
			}
		}
